...
class RedirectCard(QFrame):
    ...
    def __init__(
        ...
        self._tag_info_widget(title_label)
        self._tag_info_widget(desc_label)
        self._tag_info_widget(self.button)

    def _tag_info_widget(self, widget) -> None:
        if widget is None:
            return
    ...
    def set_dirty(self, _dirty: bool) -> None:
        return
